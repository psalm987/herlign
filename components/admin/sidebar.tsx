...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "flex h-full w-64 flex-col border-r border-gray-200 bg-white transition-transform duration-300 ease-in-out",
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ? "bg-ohrange-100 text-ohrange-900"
              ...
              >
                <item.icon
                  className={cn(
                    ...
                    isActive
                      ? "text-ohrange-600"
                      : "text-gray-500 group-hover:text-ohrange-600",
                  )}
                />
                {item.name}
              </Link>
