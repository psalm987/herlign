      ...
      <div className="max-w-6xl mx-auto px-4 ">
        ...
        <div>
          <div className="lg:grid lg:grid-cols-3 lg:items-stretch lg:gap-8">
            <div className="flex items-center  h-full lg:bg-ohrange-50 lg:border lg:border-ohrange-100 p-0 pb-8 lg:p-8 lg:rounded-3xl">
            ...
            <div className="flex items-center  h-full lg:bg-ohrange-50 lg:border lg:border-ohrange-100 p-0 pt-8 lg:p-8 lg:rounded-3xl">
