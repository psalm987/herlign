        ...
        <div className="flex flex-col-reverse bg-linear-to-b relative from-lermorn-600 via-80% via-lermorn-700 to-lermorn-800 text-white p-0 lg:p-20 rounded-2xl">
          <div className="lg:max-w-md p-6 sm:p-12 md:p-16 lg:p-0">
            ...
            <p className="sm:text-lg md:text-xl">
              ...
              balancing work and motherhood. At Herlign FC, we believe that
              every woman deserves a community that cheers her on, challenges
              her, and celebrates her progress.
            </p>
          </div>
          <div
            className={cn(
          ...
          >
            <Image
              src="/images/jpeg/our_mission_is_simple.jpg"
              height={600}
              width={400}
              alt=""
              className="rounded-t-2xl lg:rounded-2xl w-full h-50 sm:h-100 object-cover  object-[0%_20%] lg:object-bottom lg:w-auto lg:h-auto"
            />
          </div>
        </div>
