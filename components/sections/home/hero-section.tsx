...
export default function HeroSection() {
  return (
    <section className="relative pt-25 md:pt-20 pb-0 bg-linear-to-b  from-white via-white via-70% to-peenk-100 overflow-hidden">
      ...
      <Image
        src="/images/webp/hero-image-enhanced.webp"
        alt=""
        width={1500}
        height={600}
